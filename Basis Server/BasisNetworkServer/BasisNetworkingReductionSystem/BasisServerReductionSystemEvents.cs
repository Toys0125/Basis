...
namespace BasisNetworkServer.BasisNetworkingReductionSystem
{
    ...
    public partial class BasisServerReductionSystemEvents
    {
        ...
        private const int FrameMtuBudgetBytes = 1022; // stay under network MTU (~1,022 incl. headers)
        [ThreadStatic] private static FrameBuilder _tlsFrameBuilder = new FrameBuilder(); // one per parallel worker
